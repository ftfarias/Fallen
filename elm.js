...
{
	if (region.b8.ag === region.co.ag)
	{
		return 'on line ' + region.b8.ag;
	}
	return 'on lines ' + region.b8.ag + ' through ' + region.co.ag;
}
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width = F2(
	function (screenSize, columnCount) {
		return {ck: columnCount, cS: screenSize};
	});
		...
		switch (_v0) {
			...
			case 3:
				return _Utils_update(
					options,
					{
						a6: $elm$core$Maybe$Just(offset_)
					});
			default:
				return _Utils_update(
					options,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthClass = function (_v0) {
	var screenSize = _v0.cS;
	var columnCount = _v0.ck;
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {az: $elm$core$Maybe$Nothing, aA: $elm$core$Maybe$Nothing, aB: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, aD: $elm$core$Maybe$Nothing, aG: _List_Nil, a6: $elm$core$Maybe$Nothing, a7: $elm$core$Maybe$Nothing, a8: $elm$core$Maybe$Nothing, ba: $elm$core$Maybe$Nothing, bb: $elm$core$Maybe$Nothing, bh: $elm$core$Maybe$Nothing, bi: $elm$core$Maybe$Nothing, bj: $elm$core$Maybe$Nothing, bk: $elm$core$Maybe$Nothing, bl: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, br: $elm$core$Maybe$Nothing, bs: $elm$core$Maybe$Nothing, bt: $elm$core$Maybe$Nothing, bu: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, bF: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, ar: $elm$core$Maybe$Nothing, as: $elm$core$Maybe$Nothing, at: $elm$core$Maybe$Nothing, au: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		$rundis$elm_bootstrap$Bootstrap$Grid$Internal$colWidthsToAttributes(
			_List_fromArray(
				[
					...
					A2($rundis$elm_bootstrap$Bootstrap$Grid$Internal$Width, 0, 0)) : options.au,
					options.as,
					options.ar,
					options.aq,
					options.at
		...
		_Utils_ap(
			$rundis$elm_bootstrap$Bootstrap$Grid$Internal$offsetsToAttributes(
				_List_fromArray(
					[options.bb, options.a8, options.a7, options.a6, options.ba])),
			_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(
								...
								'align-self-',
								_List_fromArray(
									[options.aD, options.aB, options.aA, options.az, options.aC])),
							_Utils_ap(
								function () {
									var _v0 = options.bF;
									if (!_v0.$) {
...
var $rundis$elm_bootstrap$Bootstrap$Grid$renderCol = function (column) {
	switch (column.$) {
		case 0:
			var options = column.a.b0;
			var children = column.a.cj;
			return A2(
				$elm$html$Html$div,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {aG: _List_Nil, aV: $elm$core$Maybe$Nothing, aW: $elm$core$Maybe$Nothing, aX: $elm$core$Maybe$Nothing, aY: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing, bJ: $elm$core$Maybe$Nothing, bK: $elm$core$Maybe$Nothing, bL: $elm$core$Maybe$Nothing, bM: $elm$core$Maybe$Nothing, bN: $elm$core$Maybe$Nothing};
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Some content for my view here...')
						]))
				]))
		]));
